...
def enter_data():
    if accept_var.get() == "Accepted":
        ...
        if firstname and lastname:
            ...
            filepath = r"C:\Users\adhi\Downloads\data.xlsx"
...
nationality_combobox = ttk.Combobox(user_info_frame, values=["America", "Australia", "India", "England", "China", "Canada", "New Zealand"])
